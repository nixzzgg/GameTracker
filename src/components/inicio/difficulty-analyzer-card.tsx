...
import { fetchDifficultyAnalysis } from '@/app/(app)/inicio/actions';

export default function DifficultyAnalyzerCard() {
    const { user } = useAuth();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const response = await fetchDifficultyAnalysis(user.id, gameName);
        if (response.error) {
